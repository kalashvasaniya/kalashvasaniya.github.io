...
export const metadata: Metadata = {
  ...
  description: "My blog where I share thoughts on technology, travel, and building products as a digital nomad.",
  keywords: ["blog", "technology", "travel", "digital nomad", "product development", "Kalash Vasaniya"],
