export const post = {
  ...
  description: "Accidentally went viral and learned about social media algorithms, content creation, and authentic storytelling. Real insights from achieving 5M+ views on Twitter.",
  excerpt: "Something unexpected happened. I woke up to a phone full of notifications. Twitter was on fire. One of my tweets had blown up.",
  content: `
  ...
  seo: {
    ...
    description: "Accidentally went viral and learned about social media algorithms, content creation, and authentic storytelling. Real insights from achieving 5M+ views on Twitter.",
    keywords: ["viral tweet", "social media growth", "twitter algorithm", "content creation", "viral content", "social media marketing", "authentic content", "twitter tips"],
    openGraph: {
      title: "I got 5m views in a week just by tweeting",
