export const post = {
  ...
  content: `
    all started when i found out about <a href="https://www.x.com/marc_louvion" target="_blank" rel="noopener noreferrer" style="color: #2563eb; text-decoration: underline;">marc lou</a> and his journey of building.
...
and i finally made money out of it. first sale is always special.
          ...
          i always wanted to build a product that helps people. solo, no team, because at the same time i want to travel the world. like a nomad. check my <a href="/bucketlist" style="color: #2563eb; text-decoration: underline;" >bucket list</a>.
...
<div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 30px 0; border: 1px solid #f59e0b;">
...
<div style="background: #fef3c7; padding: 20px; border-radius: 8px; margin: 30px 0; border: 1px solid #f59e0b;">
  <p style="margin: 0; color: #92400e; font-style: italic; text-align: center;">
